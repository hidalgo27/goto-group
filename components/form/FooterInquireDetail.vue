...
const handleSubmit = async () => {
  ...
  if ($v.value.$invalid) {
    ...
    let obj = {
      ...
      el_fecha: travelDate.value
        ? moment(travelDate.value).format("YYYY-MM-DD HH:mm:ss")
        : null,
...
<template>
    ...
    <div class="w-full">
      <div class="grid grid-cols-1">
        <section class="pb-8 text-center">
          ...
          <nuxt-img
            src="/images/logos/logo-gotogroup.svg"
            class="w-[250px] md:w-[320px] mx-auto"
          ></nuxt-img>
          <h3 class="my-3 font-semibold text-gray-700 text-2xl mt-12">
            Free Quote
          </h3>
          <p class="text-gray-500">
            Select your travel preferences and we will send you a travel
            proposal.
          </p>
        </section>
        ...
        <div class="text-left mt-6">
          <h2 class="text-lg mb-5">Get a quote on this travel package:</h2>

          <h2
            class="text-xl mb-5 bg-white/30 text-center px-5 py-2 border border-gray-300 font-semibold rounded-sm"
          >
            {{ formStore.titlePackages }}
          </h2>

          <h3 class="text-lg my-5">Hotel Category</h3>
          <div
            class="grid grid-cols-12 gap-6 my-3 overflow-x-scroll no-scrollbar focus:touch-pan-x"
          >
            <div
              class="col-span-12 hidden md:col-span-2 border md:flex justify-center items-center rounded-sm"
            >
              <svg
          ...
          <h3 class="text-lg my-5">Number of travelers</h3>
          <div
            class="grid grid-cols-12 gap-6 my-3 overflow-x-scroll no-scrollbar focus:touch-pan-x"
          >
            <div
            ...
            <div class="col-span-12 md:col-span-10 grid grid-cols-7 gap-3">
              <div class="flex" v-for="n in 6" :key="n">
                ...
                <label
                  :for="'radio_' + n"
                  class="select-none w-full text-center cursor-pointer bg-white/30 text-gray-800 rounded-sm px-5 py-2 transition-colors duration-200 ease-in-out peer-checked:bg-primary peer-checked:text-white"
                >
                  {{ n }}
                </label>
              </div>
              ...
              <div class="flex">
                ...
                <label
                  :for="'radio_7'"
                  class="select-none w-full text-center cursor-pointer bg-white/30 text-gray-800 rounded-sm py-2 transition-colors duration-200 ease-in-out peer-checked:bg-primary peer-checked:text-white"
                >
                  11+
                </label>
              </div>
          ...
          <form @submit.prevent="handleSubmit">
            <div class="grid grid-cols-1 mt-6 gap-5">
              <div class="relative">
                <div class="relative">
                  <div
                    class="bg-white/30 absolute rounded-md inset-0 -z-10"
                  ></div>
                  <input
                    type="text"
                    name="search"
                    ...
                    id="fullName"
                  />
                  <label class="input-goto-label" for="fullName"
                    >Full Name</label
                  >
                  <div
                ...
                <div v-if="$v.fullName.$error" class="text-xs text-red-500">
              ...
              <div class="relative">
                ...
                <div v-if="$v.userEmail.$error" class="text-xs text-red-500">
                  <span v-if="$v.userEmail.email.$message">{{
              ...
              <div class="grid grid-cols-2 gap-3">
                <div class="relative">
                  ...
                  <div v-if="$v.company.$error" class="text-xs text-red-500">
                    Company required
                  </div>
                </div>
                ...
                <div class="relative">
                      ...
                      >
                        <template #default="{ togglePopover }">
                          ...
                          >
                            ...
                            <span v-if="travelDate">{{
                              moment(travelDate).format("YYYY-MM-DD")
                            }}</span>
                            <span class="text-gray-500" v-else
                              >Tentative travel date</span
                            >
                            <span
                              class="absolute cursor-text text-gray-500 -top-3 left-2 backdrop-blur-sm rounded-2xl px-1 transition-all duration-200 ease-in-out text-xs"
                              >Inquire Date</span
                            >
                          </button>
                        </template>
                  ...
                  <div v-if="$v.travelDate.$error" class="text-xs text-red-500">
              ...
              <div class="grid grid-cols-2 gap-3 z-40">
                <div class="relative">
                  <input
                    ...
                    ref="companyInputRef"
                    id="country_name"
                    @input="preventManualInput"
                  />
                  <label class="input-goto-label -top-3 text-gray-500"
                    >Company Country</label
                  >
                  <div
                    v-if="$v.company_country.$error"
                ...
                <div class="relative">
                  ...
                  <label
                    class="input-goto-label -top-3 text-gray-500"
                    for="phoneNumber"
                    >Phone Number</label
                  >
                  ...
                  <!--                      </svg>-->
                  <!--                    </div>-->
                  <div v-if="$v.phone.$error" class="text-xs text-red-500">
                    El nombre es requerido
                  </div>
                </div>
              </div>
              ...
              <div class="relative">
                <div class="relative">
                  ...
                  />
                  <label
                    class="input-goto-label text-xs md:text-[15px]"
                    for="commentInputRef"
                    >What can we do for you? We have it all. Just ask!</label
                  >
                  <div
                    class="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none"
                  >
            ...
            <div class="flex justify-center mt-12 relative z-20">
              <button
                type="submit"
                class="btn-primary"
                v-show="showLoader == false"
              >
                Send
              </button>
              <button
                type="button"
                class="btn-disabled w-full justify-center flex"
                disabled
  ...
  <NotificationGroup group="foo">
    <div
      class="fixed inset-0 flex z-50 items-start justify-end p-6 px-4 py-6 pointer-events-none"
    >
