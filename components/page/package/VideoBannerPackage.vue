...
defineProps({
  duration: {
    type: String, // Cambiar a Number si `duration` es un número
    required: true,
  },
  title: {
    type: String,
      ...
      <div class="overflow-hidden h-full relative rounded-md">
        ...
        <div class="relative z-10 flex items-center  w-full h-full text-center">
          <div class=" container ">
            ...
            <p class="text-white text-xl 2xl:text-lg tracking-widest font-light mt-5 ">Discover our range of Peru travel packages and find the perfect itinerary for you.</p>
          </div>
        </div>
      </div>
    </div>
