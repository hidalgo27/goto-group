        ...
        <div class="flex items-center gap-4">
          <nuxt-link to="/">
            <div class="font-playfair-display text-3xl font-medium flex items-end">
              <nuxt-img src="https://gotoperu-com.s3-us-west-1.amazonaws.com/logos/logo-gotoperu-black.png" class="h-12"></nuxt-img>
<!--              South-->
...
<!--          </template>-->
<!--        </VDropdown>-->
        <nuxt-link to="/why-book-with-us" class="menu-list" active-class="active">About us</nuxt-link>
    ...
    <div class="w-full z-30 sm:hidden">
      ...
      <div class="bg-gray-50 w-full items-center mx-auto grid grid-cols-4 gap-3 text-center">
        ...
        <nuxt-link to="/" class="block menu-list-m" active-class="active">
        ...
        <nuxt-link to="/peru-travel-packages" class="block menu-list-m" active-class="active">
        ...
        <nuxt-link to="/destinations" class="block menu-list-m" active-class="active">
...
<!--              <nuxt-link to="/booking-terms-and-conditions" class="menu-list-m  !p-4" active-class="active">booking terms and conditions</nuxt-link>-->
              <nuxt-link to="/why-book-with-us" class="menu-list-m  !p-4" active-class="active">About us</nuxt-link>
